...
season = [ '2022-2023' ]  # '2022-2023' '2023-2024'
...
for stagione in season:
    for campionato in division:
        ...
        time.sleep(2)
        # team_urls = [ f"https://fbref.com/en/squads/d609edc0/{stagione}/Internazionale-Stats" ]
...
all_matches.to_pickle(f'all_matches_{season_suffix}.pkl')
# team_urls