...
final_links = []
seconds = 15 # parametro per il time sleep (thirty pages in less than a minute)
...
print("Start all matches process" ,'\n')            
...
season_suffix = estrai_ultime_due_cifre(stagione)

#### saving final database in .pickle ####
all_matches.to_pickle(f'output_data/all_matches_{season_suffix}.pkl')
print("End all matches process" ,'\n')  
# team_urls